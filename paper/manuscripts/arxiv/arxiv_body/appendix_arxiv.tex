...
\section{Omitted proofs from Section~\ref{sec:SmallLoss}} \label{appendix:smallLossPf}
In this Section, we will establish the proofs of Theorem~\ref{thm:Regret_small_loss} and Corollary~\ref{cor:SqrtLStarInstantiation}. 
...
\subsection{Proof of Lemma \ref{lem:pnkasymptotics}}
    ...
    \begin{proposition}[\cite{Feller1991}, Chapter 3, Exercise 11]\label{prop:pnkexact}
        \[
